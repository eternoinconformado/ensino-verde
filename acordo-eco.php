					...
					<div id="main">
						<div class="inner">
							...
							<!-- Content -->
								<section>
									<header class="main">
										<h1>Protocolo de Kyoto e o Acordo de Paris</h1>
										<h5>Fichamento por: Matheus Henrique | Núcleo Temático de Educação Ambiental Interdisciplinar, 2021.2</h5>
									</header>

									<span class="image main"><img src="images/ecologia1.jpg" alt="Banner Energia Renovavel" /></span>
